...
const user_response_dto_1 = require("../users/user.response.dto");
let AuthController = class AuthController {
    ...
    async postUsers(user) {
        ...
        return new user_response_dto_1.UserResponseDto(newUser);
    }
};
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("../users/user.response.dto").UserResponseDto }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [users_dto_1.CreateUserDto]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "postUsers", null);
